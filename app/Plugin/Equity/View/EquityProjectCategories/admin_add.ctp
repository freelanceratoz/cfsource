...
<?php echo $this->Form->create('EquityProjectCategory', array('class' => 'form-horizontal'));?>
	<fieldset>
		<ul class="breadcrumb">
			...
			<li class="active"><?php echo sprintf(__l('Add %s'), sprintf(__l('%s %s Category'), Configure::read('project.alt_name_for_equity_singular_caps'), Configure::read('project.alt_name_for_project_singular_caps')));?></li>
		</ul>
