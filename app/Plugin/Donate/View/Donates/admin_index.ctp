...
<div class="main-admn-usr-lst js-response">	
  <div class="row navbar-btn clearfix thumbnail no-border">        
	  ...
	  <div class="col-md-3 col-sm-4 col-xs-12 col-lg-offset-0 col-sm-offset-4 img-thumbnail marg-top-30 clearfix">
		<h3 class="text-left"><?php echo __l('Project Status'); ?></h3>
		  ...
		  <div class="pull-left text-info">
			...
			<div><?php echo __l('Not Genuine') . ': '.$failed_projects; ?> <i title="<?php echo __l('Funding closed, but project owner did fraudulent'); ?>" class="fa fa-question-circle js-tooltip"  data-placement="left"></i></div>
		  </div>		 		
	  </div>        
	</div>    
	<div class="row bg-primary">		
		<ul class="list-inline sec-1 navbar-btn">
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block act-usr text-center">'.$this->Html->cInt($active_projects,false).'</span><span>' .__l('Active'). '</span>', array('controller'=>'donates','action'=>'index','filter_id' => ConstMoreAction::Active), array('escape' => false));?>
				</div>
			</li>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center ina-usr">'.$this->Html->cInt($inactive_projects,false).'</span><span>' .__l('Inactive'). '</span>', array('controller'=>'donates','action'=>'index','filter_id' => ConstMoreAction::Inactive), array('escape' => false));?>
				</div>
			</li>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center ste-usr">'.$this->Html->cInt($featured_projects,false).'</span><span>' .__l('Featured'). '</span>', array('controller'=>'donates','action'=>'index','filter_id' => ConstMoreAction::Featured), array('escape' => false));?>
				</div>
			</li>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center twtr-usr">'.$this->Html->cInt($suspended,false).'</span><span>' .__l('Suspended'). '</span>', array('controller'=>'donates','action'=>'index','filter_id' => ConstMoreAction::Suspend), array('escape' => false, 'title' => __l('Suspended')));?>
				</div>
			</li>
			<?php if(isPluginEnabled('ProjectFlags')): ?>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center lkdn-usr">'.$this->Html->cInt($system_flagged,false).'</span><span>' .__l('System Flagged'). '</span>', array('controller'=>'donates','action'=>'index','filter_id' => ConstMoreAction::Flagged), array('escape' => false));?>
				</div>
			</li>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center yho-usr">'.$this->Html->cInt($user_flagged,false).'</span><span>' .__l('User Flagged'). '</span>', array('controller'=>'donates','action'=>'index','filter_id' => ConstMoreAction::UserFlagged), array('escape' => false));?>
				</div>
			</li>
			<?php endif; ?>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center fb-usr">'.$this->Html->cInt($system_drafted,false).'</span><span>' .__l('Drafted'). '</span>', array('controller'=>'donates','action'=>'index','filter_id' => ConstMoreAction::Drafted), array('escape' => false));?>
				</div>
			</li>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center opn-i-usr">'.$this->Html->cInt($active_projects + $inactive_projects,false).'</span><span>' .__l('All'). '</span>', array('controller'=>'donates','action'=>'index'), array('class' => 'text-center','escape' => false));?>
				</div>
			</li>
		</ul>		
	</div>
	<div class="clearfix donates">
		<div class="navbar-btn">			
			<h3>
				<i class="fa fa-th-list"></i> <?php echo __l('List');?>&nbsp;
				<?php echo $this->Html->link('<button type="button" class="btn btn-success">'.__l('Add').' &nbsp;<span class="badge"><i class="fa fa-plus"></i></span></button>', array('controller' => 'projects', 'action' => 'add', 'project_type' => 'donate'),array('title' =>  __l('Add'), 'escape' => false));?>
			</h3>
			<ul class="list-unstyled clearfix">
				...
				<li class="pull-right"> 
					<div class="form-group srch-adon">
						  <?php echo $this->Form->create('Project' ,array('url' => array('controller' => 'projects','action' => 'index','project_type'=>'Donate')),array('type' => 'get', 'class' => 'form-search','action' => 'index')); ?>
			...
			<table class="table table-striped table-bordered" id="js-expand-table">
				<thead class="h5">
					<tr class="js-even">  
						...
						<th rowspan="2" class="text-center"><div><?php echo $this->Paginator->sort('name', __l('Name'));?></div></th>
						...
						<div><?php echo sprintf(__l('%s Date'), Configure::read('project.alt_name_for_donate_present_continuous_caps') ); ?><div><?php echo $this->Paginator->sort('project_start_date', __l('Start'));?></div>/<div><?php echo $this->Paginator->sort('project_end_date', __l('End'));?></div></div>
						</th>
				...
				<tbody class="h5">
					...
					<tr class="<?php echo $class .$disabled. $altrow_class;?> cur">
						...
						<i title="<?php echo !empty($project['Donate']['DonateProjectStatus'])?$this->Html->cText($project['Donate']['DonateProjectStatus']['name'], false):'Drafted';?>" class="fa fa-square project-status-<?php echo $this->Html->cInt($project['Donate']['donate_project_status_id'], false);?>"></i>
						...
						<div class="progress">
						<div style="width:<?php echo ($collected_percentage > 100) ? '100%' : $collected_percentage.'%'; ?>;" title = "<?php echo $this->Html->cFloat($collected_percentage, false).'%'; ?>" class="progress-bar progress-bar-success"></div>
						</div>
						...
						<td class="text-center"><span class="label label-success"><?php echo $this->Html->cCurrency($project['Project']['fee_amount']);?></span></td>
						<td class="text-center"><span class="label label-success"><?php echo $this->Html->cCurrency($project['Project']['commission_amount']);?></span></td>
						<td class="text-center">
						<?php
						...
						<div class="progress">
						<div style="width:<?php echo ($project_progress_precentage > 100) ? '100%' : $project_progress_precentage.'%'; ?>;" title = "<?php echo $this->Html->cFloat($project_progress_precentage, false).'%'; ?>" class="progress-bar progress-bar-success"></div>
						</div>
						<?php endif; ?>
							...
							<div class="clearfix row">
								<div class="col-xs-2">
									...
									<ul class="list-unstyled clearfix line-height-25">
										...
										<li><?php echo $this->Html->link('<i class="fa fa-hdd-o fa-fw"></i>'.sprintf(__l('Change status to %s'),Configure::read('project.alt_name_for_donate_singular_small')), array('controller'=>'projects','action'=>'admin_open_funding', $project['Project']['id'], 'type' => 'open'), array('class' => 'js-confirm',  'escape'=>false,'title' => sprintf(__l('Change status to %s'),Configure::read('project.alt_name_for_donate_singular_small'))));?></li>
										<?php endif; ?>
										...
										<li><?php echo $this->Html->link('<i class="fa fa-times-circle-o"></i>'.__l('Clear System Flag'), array('controller'=>'projects','action' => 'admin_update_status', $project['Project']['id'], 'status' => 'unflag', 'project_type' => $project['ProjectType']['slug']), array('class' => 'js-confirm', 'escape'=>false, 'title' => __l('Clear System Flag')));?></li>
										<?php else: ?>
										<?php if($project['Donate']['donate_project_status_id'] == ConstDonateProjectStatus::OpenForDonating || $project['Donate']['donate_project_status_id'] == ConstDonateProjectStatus::Pending || $project['Donate']['donate_project_status_id'] == ConstDonateProjectStatus::OpenForIdea):?>
								...
								<div class="col-xs-3">
									...
									<dl class="clearfix project-action">
										...
										<dt class="col-xs-7"><?php echo Configure::read('project.alt_name_for_donor_plural_caps') ?></dt>
										<dd class="col-xs-3"><?php echo $this->Html->link($this->Html->cInt($project['Project']['project_fund_count']), array('controller'=> 'donates', 'action' => 'funds', 'project_id' => $project['Project']['id']), array('escape' => false)); ?></dd>
								...
								<div class="col-xs-4 top-space top-mspace">
									<dl class="clearfix line-height-25 top-space top-mspace h4">
										<dt class="text-left col-xs-5 no-pad text-warning"><?php echo __l('Posted On'); ?></dt>
										<dd class="col-xs-4"><?php echo $this->Html->cDateTimeHighlight($project['Project']['created']); ?></dd>
										<dt class="text-left col-xs-5 no-pad text-warning"><?php echo __l('Listing Fee Paid'); ?></dt>
					...
					?>
					<tr class="js-even">
						<td colspan="22" class="text-center text-danger"><i class="fa fa-exclamation-triangle fa-fw"></i><?php echo sprintf(__l('No Donation %s available'), Configure::read('project.alt_name_for_donate_project_plural_caps'));?></td>
					</tr>
					<?php
					endif;
					?>
...
<div class="modal fade" id="js-ajax">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer"> <a href="#" class="btn btn-default js-no-pjax" data-dismiss="modal"><?php echo __l('Close'); ?></a> </div>
		</div>
	</div>
</div>
