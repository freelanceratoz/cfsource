...
echo '<svg
 ...
 <script type="text/ecmascript">
  ...
  function create_multiline(text, x, y, tooltip_X, tooltip_Y) {
    ...
    text_element.setAttributeNS(null, "y", y + (tooltip_Y + 20));
    ...
    tspan_element.setAttributeNS(null, "x", x - tooltip_X);
    ...
    bg_element.setAttributeNS(null,"width", 190);
    bg_element.setAttributeNS(null,"height", height + 30);
    bg_element.setAttributeNS(null, "x", x-(tooltip_X+5));
    bg_element.setAttributeNS(null, "y", y+tooltip_Y);
  }
  ...
  function HideTooltip(evt, curObj) {
    curObj.setAttributeNS(null,"class",'circle first');
 ...
 <?php echo'<sodipodi:namedview
  ...
  echo'<g
    ...
    echo'<g
     ...
     id="g9211">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'projects','action'=>'add','project_type'=> "donate"),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<g
     ...
     id="g9139">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'donates','action'=>'index','project_status_id' => ConstDonateProjectStatus::Pending),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<g
     ...
     id="g9216">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'donates','action'=>'index','project_status_id' => ConstDonateProjectStatus::OpenForDonating),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<text
       ...
       x="484.0293"
       y="246.46765"
       style="font-size:12px;font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;fill:#ffffff;fill-opacity:1;font-family:Arial;-inkscape-font-specification:Arial">'.sprintf(__l('Open for %s'), Configure::read('project.alt_name_for_donate_present_continuous_caps')) . ' (' . $this->Html->cInt($opened_project_count,false) . ')'.'</tspan>'; echo'</text>';
    echo '</a>';
    echo'</g>';
	echo'<path
     inkscape:connector-curvature="3"
	...
	echo'<g
     ...
     id="g9238">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'donates','action'=>'index','project_status_id' => ConstDonateProjectStatus::FundingExpired),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
	...
	echo'<g
     ...
     id="g9238">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'donates','action'=>'index','project_status_id' => ConstDonateProjectStatus::PendingAction),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<text
       ...
       x="250.6748"
       y="327.39441"
       style="font-size:12px;font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;fill:#ffffff;fill-opacity:1;font-family:Arial;-inkscape-font-specification:Arial">'.sprintf(__l('Pending Action to Admin (%s)'),$this->Html->cInt($expired_project_count,false)).'</tspan>'; echo'</text>';
    echo '</a>';
    echo'</g>';
	echo'<path
     inkscape:connector-curvature="3"
    ...
    echo'<g
     ...
     id="g9226">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'donates','action'=>'index','project_status_id' => ConstDonateProjectStatus::FundingClosed),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<g
     ...
     id="g9105">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'donates','action'=>'index','transaction_type_id' => ConstTransactionTypes::ListingFee),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
       style="fill:#ffad46;fill-opacity:0;stroke:#abab57;stroke-width:0.99319583;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:1.98639164, 1.98639164;stroke-dashoffset:0"
       id="rect5597-4-27"
       width="142.00681"
       height="24.006804"
       x="123.99659"
   ...
   echo '</a>';
    ...
    echo'<g
     ...
     id="g9105-2">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'donates','action'=>'index','project_status_id' => ConstDonateProjectStatus::OpenForIdea),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
       style="fill:#49C8F5;fill-opacity:0;stroke:#abab57;stroke-width:0.92958486;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:1.85916971, 1.85916971;stroke-dashoffset:0"
       id="rect5597-4-27-4"
       width="124.07042"
       height="24.070414"
       x="137.96478"
    ...
    echo'<text
       ...
       x="142.6748"
       y="163.39441"
       style="font-size:12px;font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;fill:#49C8F5;fill-opacity:1;font-family:Arial;-inkscape-font-specification:Arial"> '.__l('Open for Voting') . ' (' . $this->Html->cInt($open_for_idea,false) . ')'.'</tspan>'; echo'</text>';
    echo '</a>';
    echo'</g>';
    echo'<path
    ...
    echo'<g
     ...
     onmousemove="ShowTooltip(evt, \''.sprintf(__l('If listing fees added in settings, all %s can be added only when the %s pays the fees'), Configure::read('project.alt_name_for_project_plural_small'), Configure::read('project.alt_name_for_project_owner_singular_small')).'\',this, 50, 130)"
    ...
    echo'</g>';
    echo'<g
     transform="matrix(0.71715729,0,0,0.70227083,65.46661,486.72137)" class="circle first"
    ...
    echo'<g
     ...
     onmousemove="ShowTooltip(evt, \''.sprintf(__l('If idea is enabled, initially all the %s will be considered as an idea. Based on votes, it will be moved as a %s by administrator.'), Configure::read('project.alt_name_for_project_singular_small'), Configure::read('project.alt_name_for_project_singular_small')).'\',this, 50, 130)"
     onmouseout="HideTooltip(evt, this)"
     id="g10936-6">';
    echo'<rect
       style="fill:#404040;fill-opacity:1;fill-rule:nonzero"
	...
	echo'<g
     ...
     onmousemove="ShowTooltip(evt, \''.sprintf(__l('If no %s available and the %s reached end date then %s automatically moved to expire'), Configure::read('project.alt_name_for_donate_plural_small'), Configure::read('project.alt_name_for_project_singular_small'), Configure::read('project.alt_name_for_project_singular_small')).'\',this, 50, 25)"
     onmouseout="HideTooltip(evt, this)"
     id="g10936">';
    echo'<rect
       style="fill:#404040;fill-opacity:1;fill-rule:nonzero"
    ...
    echo'</g>';
    echo'<g
     transform="matrix(0.71715729,0,0,0.70227083,524.46661,487.72137)" class="circle first"
     onmousemove="ShowTooltip(evt, \''. sprintf(__l('%s accepting %s from %s.'), Configure::read('project.alt_name_for_project_plural_caps'), Configure::read('project.alt_name_for_donate_present_continuous_plural_small'), Configure::read('project.alt_name_for_donor_plural_caps')).'\',this, 50, 130)"
     onmouseout="HideTooltip(evt, this)"
     id="g10936-5">';
    echo'<rect
       style="fill:#404040;fill-opacity:1;fill-rule:nonzero"
    ...
    echo'</g>';
    echo'<g
     transform="matrix(0.71715729,0,0,0.70227083,804.46661,487.72137)" class="circle first"
     onmousemove="ShowTooltip(evt, \''.sprintf(__l('All fundings captured and needed amount moves to %s PayPal account and commission amount moves to site admin PayPal account.'), Configure::read('project.alt_name_for_donate_project_owner_singular_small')).'\',this, 175, 60)"
     onmouseout="HideTooltip(evt, this)"
     id="g10936-3">';
    echo'<rect
       style="fill:#404040;fill-opacity:1;fill-rule:nonzero"
 ...
 echo '<rect x="10" y="10" height="20" rx="5" ry="5" style=" fill:black" class="tooltip_bg" id="tooltip_bg" visibility="hidden"></rect>';
  echo '<text class="tooltip" id="tooltip" visibility="hidden" style="fill:#fff; font-size:11px; font-family:Arial;">Tooltip</text>';
  echo'<style
   id="style3">';
  echo'g.button:hover{
  opacity: 0.75;
