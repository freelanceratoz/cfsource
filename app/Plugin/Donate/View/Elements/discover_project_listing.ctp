...
<section class="bg-success clearfix sec-1 bg-donate padd" itemtype="http://schema.org/Product" itemscope>
	<div class="container" itemprop="Name">
		<div class="text-center well-sm h3 clearfix">
			...
			<h4 class="lead fa-inverse col-lg-8 col-lg-offset-2 trun marg-top-100" title="<?php echo sprintf(__l("In %s %s, transfer amount to project owner Immediately."), Configure::read('project.alt_name_for_donate_singular_small'), Configure::read('project.alt_name_for_project_plural_small'), Configure::read('project.alt_name_for_reward_plural_small')); ?>" itemprop="description">
