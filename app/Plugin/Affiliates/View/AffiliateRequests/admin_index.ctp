			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th class="text-left"><?php echo $this->Paginator->sort('User.username', __l('User'));?></th>
				...
				<tbody class="h6">
					...
					<tr <?php echo $disabled;?>>
						...
						<td class="text-left"><div class="js-tooltip htruncate col-xs-5" title="<?php echo $this->Html->cText($affiliateRequest['AffiliateRequest']['why_do_you_want_affiliate'], false);?>"><?php echo $this->Html->cText($affiliateRequest['AffiliateRequest']['why_do_you_want_affiliate'], false);?></div></td>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6 pull-left">
				<ul class="list-inline clearfix">
					...
					<li class="navbar-btn">
						<?php echo $this->Html->link(__l('Disapprove'), '#', array('class' => 'text-info js-select js-no-pjax {"checked":"js-checkbox-inactive","unchecked":"js-checkbox-active"}', 'title' => __l('Disapprove'))); ?>
					</li>
					<li class="navbar-btn">
						<?php echo $this->Html->link(__l('Approve'), '#', array('class' => 'text-info js-select js-no-pjax {"checked":"js-checkbox-active","unchecked":"js-checkbox-inactive"}', 'title' => __l('Approve'))); ?>
					</li>
					<li>
