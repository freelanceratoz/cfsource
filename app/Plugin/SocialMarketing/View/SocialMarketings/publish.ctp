...
?>
<div class="space <?php echo $class; ?>">
    ...
    <?php if ($this->request->params['named']['type'] != 'import') { ?>
      ...
      <div class="<?php echo $project['ProjectType']['slug']; ?>">
        <ul class="list-inline">
          <li><span class="label label-primary share-follow <?php echo ($this->request->params['named']['type'] == 'facebook')? 'badge-module' : ''; ?>"><?php echo __l('Facebook'); ?></span></li>
          <li><span class="label label-info share-follow <?php echo ($this->request->params['named']['type'] == 'twitter')? 'badge-module' : ''; ?>"><?php echo __l('Twitter'); ?></span></li>
          <li><span class="label label-danger share-follow <?php echo ($this->request->params['named']['type'] == 'others')? 'badge-module' : ''; ?>"><?php echo __l('Others'); ?></span></li>
        </ul>
      </div>
    <?php } ?>
    <div class="clearfix marg-top-30">
      <div class="<?php echo ($this->request->params['named']['type'] != 'others') ? 'col-md-6' : ''; ?>">
        <div class="hide"><?php echo $this->Html->image('throbber.gif', array('alt' => __l('[Image: Throbber]') ,'width' => 25, 'height' => 25)); ?><img width="220" height="165" src="<?php echo $this->Html->cText($project_image, false); ?>"/ alt="[Image: Project image]" title="Project image"></div>
        <?php if ($this->request->params['named']['type'] == 'facebook') { ?>
          ...
          <div class="loader" id="js-loader" data-fb_connect="<?php echo $fb_connect; ?>" data-fb_app_id="<?php echo Configure::read('facebook.app_id'); ?>" data-project_url="<?php echo $project_url; ?>" data-project_image="<?php echo $project_image; ?>" data-project_name="<?php echo urlencode($this->Html->cText($project['Project']['name'], false)); ?>" data-caption="<?php echo urlencode($this->Html->cText($project['Project']['information'], false)); ?>" data-description="<?php echo urlencode($this->Html->cText($description, false)); ?>" data-redirect_url="<?php echo $redirect_url; ?>" data-type="iframe">
            ...
            <div id="js-FB-Share-beforelogin" class="hide">
              <div>
                <p class="clearfix"><?php echo $this->Html->link($this->Html->image('facebooklogin.png', array('alt' => __l('Connect with Facebook'))), $connect_url, array('title' => __l('Connect with Facebook'),'class' => "pull-left js-tooltip js-connect js-no-pjax",'data-url' => $connect_url, 'escape' => false)); ?></p>
        ...
        <?php } else if($this->request->params['named']['type'] == 'others') { ?>
          <div class="clearfix"id="js-others">
            <ul class="list-inline other-social clearfix">
              <li>
					<div>
    ...
    <div class="clearfix form-actions text-right col-md-10 js-skip-show hide">
      <?php
        if ($this->request->params['named']['type'] == 'others') {
          echo $this->Html->link(__l('Done'), array('controller' => 'projects', 'action' => 'view', $project['Project']['slug']), array('title' => __l('Done'),'class' => 'pull-right js-no-pjax js-tooltip btn btn-info'));
        } else {
