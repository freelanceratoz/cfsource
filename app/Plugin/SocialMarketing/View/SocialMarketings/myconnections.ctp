<div class="container social-myconnect setting-drop-menu">
	<div class="clearfix user-heading">
		<h3 class="col-xs-8 col-sm-6 h2 text-uppercase navbar-btn"><?php echo __l('Social'); ?></h3>
		<div class="col-xs-4 col-sm-6 navbar-btn">
	...
	<div class="thumbnail text-center">
	  ...
	  <div class="page-header clearfix">
		...
		<?php } else { ?>
		  ...
		  ?>
		  <div class="col-md-3 navbar-btn"><?php echo $this->Html->link(sprintf(__l('Connect with %s'), __l('Facebook')), $connect_url, array('title' => sprintf(__l('Connect with %s'),__l('Facebook')) , 'class' => 'js-connect js-no-pjax btn btn-primary form-control','data-url' => $connect_url)); ?></div>
		<?php } ?>
	  </div>
	  <div class="page-header clearfix">
		...
		<?php } else { ?>
		  ...
		  ?>
		  <div class="col-md-3 navbar-btn"><?php echo $this->Html->link(sprintf(__l('Connect with %s'), __l('Twitter')), $connect_url, array('title' => sprintf(__l('Connect with %s'), __l('Twitter')),'class' => 'js-connect js-no-pjax btn btn-info form-control','data-url' => $connect_url)); ?></div>
		<?php } ?>
	  </div>
	  <div class="page-header clearfix">
		...
		<?php } else { ?>
		  ...
		  ?>
		  <div class="col-md-3 navbar-btn"><?php echo $this->Html->link(sprintf(__l('Connect with %s'), __l('Gmail')), $connect_url, array('title' => sprintf(__l('Connect with %s'), __l('Gmail')),'class' => 'js-connect js-no-pjax btn btn-success form-control','data-url' => $connect_url));
		  ?></div>
		<?php } ?>
	  </div>
	  <div class="page-header clearfix">
		<div class="col-md-1 text-46 navbar-btn"><i class="fa fa-google-plus-square text-warning fa-3x"></i></div>
		...
		<?php } else { ?>
		  ...
		  ?>
		  <div class="col-md-3 navbar-btn"><?php echo $this->Html->link(sprintf(__l('Connect with %s'), __l('Google+')), $connect_url, array('title' =>sprintf(__l('Connect with %s'), __l('Google+')),'class' => 'js-connect js-no-pjax btn btn-warning form-control','data-url' => $connect_url));
		  ?></div>
		<?php } ?>
	  </div>
	  <div class="page-header clearfix">
		<div class="col-md-1 text-46 navbar-btn"><i class="fa fa-hacker-news text-danger fa-3x"></i></div>
		...
		<?php } else { ?>
		  ...
		  <div class="col-md-3 navbar-btn"><?php echo $this->Html->link(sprintf(__l('Connect with %s'), __l('Yahoo!')), $connect_url, array('title' => sprintf(__l('Connect with %s'), __l('Yahoo!')), 'class' => 'js-connect js-no-pjax btn btn-danger form-control','data-url' => $connect_url));
		  ?></div>
		<?php } ?>
	  </div>
	  <div class="page-header no-bor clearfix text-info">
		<div class="col-md-1 text-46 navbar-btn"><i class="fa fa-linkedin-square fa-3x"></i></div>
		...
		<?php } else { ?>
		  ...
		  ?>
		  <div class="col-md-3  navbar-btn"><?php echo $this->Html->link(sprintf(__l('Connect with %s'), __l('Linkedin')), $connect_url, array('title' => sprintf(__l('Connect with %s'), __l('Linkedin')) ,'class' => 'js-connect js-no-pjax btn btn-info form-control','data-url' => $connect_url));
		  ?></div>
		<?php } ?>
	  </div>
	</div>
