      ...
      <?php if ($this->request->params['named']['type'] == 'facebook') { ?>
        <div id="facebook" class="facebook loader fade in active" data-fb_app_id="<?php echo Configure::read('facebook.app_id') ?>">
          ...
          ?>
              ...
              <div class="col-md-8">
                <iframe src="<?php echo $feed_url; ?>" height="500" width="500"  frameborder="0" scrolling="yes"></iframe>
              </div>
              <div class="col-md-3">
          ...
          <div class="text-center">
			<?php echo $this->Html->link($this->Html->tag('i','', array('class'=>'fa fa-facebook fa-fw')).$this->Html->tag('span','Find Friends From Facebook'), array('controller' => 'social_marketings', 'action' => 'import_friends', 'type' => $this->request->params['named']['type'], 'import' => 'facebook'), array('class'=>'btn btn-primary js-connect js-no-pjax', 'data-url' => $connect_url ,'title' => __l('Find Friends From Facebook'),'escape' => false)); ?></div></div>
		 </div>
        ...
        <div id="twitter" class="twitter">
          ...
          <?php } else { ?>
            ...
            <div class="text-center"><?php echo $this->Html->link($this->Html->tag('i','', array('class'=>'fa fa-twitter fa-fw')).$this->Html->tag('span','Find Friends From Twitter', array('class'=>'')), $connect_url, array('class'=>'btn btn-info  js-connect js-no-pjax','data-url' => $connect_url,'title' => __l('Find Friends From Twitter'), 'escape' => false)); ?></div>
          <?php } ?>
        </div>
      <?php } elseif ($this->request->params['named']['type'] == 'gmail') { ?>
        <div id="gmail" class="gmail">
          ...
          <?php } else { ?>
            ...
            <div class="text-center">
			<?php echo $this->Html->link($this->Html->tag('i','', array('class'=>'fa fa-envelope fa-fw ')).$this->Html->tag('span','Find Friends From Gmail', array('class'=>'')), array('controller' => 'social_marketings', 'action' => 'import_friends', 'type' => $this->request->params['named']['type'], 'import' => 'google'), array('class'=>'btn btn-danger js-connect js-no-pjax', 'data-url' => $connect_url ,'title' => __l('Find Friends From Gmail'), 'escape' => false)); ?></div>
          <?php } ?>
        </div>
      <?php } elseif ($this->request->params['named']['type'] == 'yahoo') { ?>
        <div id="yahoo" class="yahoo">
          ...
          <?php } else { ?>
            ...
            <div class="text-center">
			 <?php echo $this->Html->link($this->Html->tag('i','', array('class'=>'fa fa-yahoo fa-fw')).$this->Html->tag('span','Find Friends From Yahoo', array('class'=>'')), array('controller' => 'social_marketings', 'action' => 'import_friends', 'type' => $this->request->params['named']['type'], 'import' => 'yahoo'), array('class'=>'btn btn-success js-connect js-no-pjax', 'data-url' => $connect_url ,'title' => __l('Find Friends From Yahoo'), 'escape' => false)); ?></div>
          <?php } ?>
        </div>
      <?php } ?>
    </div>
  ...
  <li class="form-actions navbar-btn clearfix ver-space">
    <?php
      if ($this->request->params['named']['type'] == 'yahoo') {
        ...
        echo $this->Html->link(__l('Skip') . ' >>', array('controller' => 'social_marketings', 'action' => 'import_friends',  'type' => $next_action), array('title' => __l('Skip'). ' >>', 'class' => 'btn btn-info btn-xs pull-right show float-none js-tooltip'));
      }
    ?>
  </li>
 </ul>
