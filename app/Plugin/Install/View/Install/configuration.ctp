<div class="install form">
	...
	<div class="content-block round-4">
		...
		<fieldset>
			...
			<div class="configration-details info-details">Facebook is used for login and posting message using its account details. For doing above, our site must be configured with existing Facebook account. <a href="https://google.com"> https://google.com?id=facebook-setup </a></div>
		...
		<fieldset>
			...
			<div class="configration-details info-details">Twitter is used for login and posting message using its account details. For doing above, our site must be configured with existing Twitter account. <a href="https://google.com?id=twitter-setup"> https://google.com?id=twitter-setup </a></div>
