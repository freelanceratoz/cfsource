			...
			<table class="table table-striped">
				<thead class="h5">
					<tr>
						...
						<?php if(empty($this->request->params['named']['view_type'])) : ?>
						  <th><div><?php echo $this->Paginator->sort('Project.name', __l(Configure::read('project.alt_name_for_project_singular_caps')), array('class' => 'js-no-pjax js-filter'));?></div></th>
						<?php endif; ?>
