...
?>
<div class="container job-entry">
	<div class="marg-top-20">
		   <div data-offset-top="10" data-spy="" class=" <?php echo $class; ?>">
			  <div class="media">
			  <div class="pull-left payment-img"> <?php echo $this->Html->link($this->Html->showImage('Project', $project['Attachment'], array('dimension' => 'medium_thumb', 'alt' => sprintf(__l('[Image: %s]'), $this->Html->cText($project['Project']['name'], false)), 'title' => $this->Html->cText($project['Project']['name'], false), 'class' => 'js-tooltip'),array('aspect_ratio'=>1)), array('controller' => 'projects', 'action' => 'view',  $project['Project']['slug'], 'admin' => false), array('escape' => false)); ?> </div>
			  <div class="media-body">
				  <h3 class="no-mar"><?php echo $this->Html->link($this->Html->filterSuspiciousWords($this->Html->cText($project['Project']['name'], false), $project['Project']['detected_suspicious_words']), array('controller' => 'projects', 'action' => 'view', $project['Project']['slug']), array('escape' => false));?></h3>
				  <p> <?php echo __l('A') . ' '; ?>
						<?php
	...
	<div class="JobsAct form equity">
	  <div class="alert alert-info">
		<h4 class="text-center"><?php echo __l('Jumpstart Our Business Startups (JOBS) Compliance'); ?></h4>
	...
	<div class="panel panel-info well-sm equity gray-bg admin-form">
		  <?php echo $this->Form->create('JobsActEntry', array('class' => 'form-horizontal')); ?>
		  <div>
			<div class="clearfix">
			  <div class="pull-left">
				<div class="alert alert-danger clearfix"><?php echo __l('Please enter with care, you can\'t update these details later. This is one-time-process.'); ?></div>
				<?php
