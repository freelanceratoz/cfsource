...
<section class="h1  sec-1">
	<div class="container">
		<div class="text-center col-xs-12 h1">
			<p class="h3 col-xs-12"><?php echo __l(	'Personalize, mold and replicate the entire business model for your nation, language, currency and preferred niches with our world class Crowdfunding fundraising software with optional modules for Pledge, Equity, Lend & Donate based on your business model. Just install it on your server to easily create, launch, manage and maintain a Next Generation Crowdfunding platform in days.');?></p>
				...
				<div id="ajax-tab-container-feature-project" class='tab-container'>
					<div class="col-xs-12 clearfix">
						...
						<div class="pull-right h1 well-lg list-group-item-heading list-group-item-text">
							<h3 class="h5 text-primary list-group-item-text">
