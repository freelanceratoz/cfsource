	...
	<div class="container-fluid bg-primary">
		<div class="row">
			<p class="text-center well-lg">
				...
				<?php echo $this->Html->link(sprintf(__l('%s Web Development'), 'google'), 'https://google.com', array('target' => '_blank', 'title' => sprintf(__l('%s Web Development'), 'google'), 'class' => 'js-no-pjax'));?>  
