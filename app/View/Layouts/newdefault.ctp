...
<head>
        ...
        <!-- Plugins CSS -->
        <link href="<?php echo $this->webroot; ?>asset/css/plugins/plugins.css" rel="stylesheet">
        <link href="<?php echo $this->webroot; ?>asset/linearicons/fonts.css" rel="stylesheet">
        <link rel="stylesheet" href="<?php echo $this->webroot; ?>asset/masterslider/style/masterslider.css" />
        <link rel="stylesheet" href="<?php echo $this->webroot; ?>asset/css/master-slider-custom.css" />
        <!-- load css for cubeportfolio -->
        <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>asset/cubeportfolio/css/cubeportfolio.min.css">
        <link href="<?php echo $this->webroot; ?>asset/css/style.css" rel="stylesheet">
    </head>
    ...
    <body>
                        ...
                        <div id="masterslider" class="master-slider ms-skin-default" >
                            <div class="ms-slide" data-delay="10" data-fill-mode="fill" >
                                ...
                                <img class="ms-layer"
                                     ...
                                     data-origin="tl"
                                     data-position="normal" />
                                <div class="ms-layer ms-title msp-cn-119-21"
                                     style=""
                                     data-effect="t(true,n,50,-50,n,n,n,n,1.5,1.5,n,n,n,n,n)"
                                     data-duration="2600"
                                     data-delay="4112"
                                     data-ease="easeOutQuint"
                                     data-offset-x="375"
                                ...
                                <a href="#"
                                   ...
                                   data-offset-y="315"
                                   data-origin="tl"
                                   data-position="normal" >SEE MORE</a>
                            </div>
                            <div class="ms-slide" data-delay="5" data-fill-mode="fill" >
                                <img class="ms-layer"
                                     ...
                                     data-origin="tl"
                                     data-position="normal" />
                                <div class="ms-layer msp-cn-119-10 text-white"
                                     style=""
                            ...
                            <div class="ms-slide" data-delay="5" data-fill-mode="fill" >
                                <img class="ms-layer"
                                     ...
                                     data-origin="tl"
                                     data-position="normal" />
                                <div class="ms-layer msp-cn-119-16"
                                     style=""
                                     ...
                                     data-offset-y="227"
                                     data-origin="tl"
                                     data-position="normal" >complete guide to</div>
                                <div class="ms-layer ms-title msp-cn-119-14"
                                     style=""
                                     data-effect="t(true,n,60,n,n,n,n,n,n,n,n,n,n,n,n)"
                                     data-duration="4000"
                                     data-delay="1600"
                                     data-ease="easeOutQuint"
                                     data-offset-x="545"
                            ...
                            <div class="col-lg-8 mr-auto pb50 ml-auto">
                                ...
                                <div class="experience-card clearfix">
                                    <div class="experience-inner">
                                        <h3 class="experience-text">09</h3>
                                    </div> 
                        ...
                        <div class="container pt100 pb50">
                            <div class="row">
                                <div class="col-lg-3 col-md-6 pb50 text-center">
                                    <i class="icon-folder-picture fa-3x text-primary"></i>
                                    <h3 class="text-white h1 mb0 pt30 counter">
                                        768
                                    </h3>
                                    <p class="text-white">
                                        Projects
                                ...
                                <div class="col-lg-3 col-md-6 pb50 text-center">
                                    <i class="icon-users fa-3x text-primary"></i>
                                    <h3 class="text-white h1 mb0 pt30 counter">
                                        435
                                    </h3>
                                    <p class="text-white">
                                ...
                                <div class="col-lg-3 col-md-6 pb50 text-center">
                                    <i class="icon-timer2 fa-3x text-primary"></i>
                                    <h3 class="text-white h1 mb0 pt30 counter">
                                        9483
                                    </h3>
                                    <p class="text-white">
                                ...
                                <div class="col-lg-3 col-md-6 pb50 text-center">
                                    <i class="icon-network fa-3x text-primary"></i>
                                    <h3 class="text-white h1 mb0 pt30  counter">
                                        400
                                    </h3>
                                    <p class="text-white">
                        ...
                        <div class="container"> 
                            <div class="row">
                                ...
                                <div class="col-lg-8 text-right">
                                    ...
                                    <span class="text-white-gray font300">&copy; Copyright 2014-2017. All Right Reserved</span>
                                </div>
                            </div>
                        </div>
                    </footer><!--footer-->
        ...
        <script type="text/javascript" src="<?php echo $this->webroot; ?>asset/js/plugins/plugins.js"></script> 
        <script type="text/javascript" src="<?php echo $this->webroot; ?>asset/js/archi.custom.js"></script> 
        <script type="text/javascript" src="<?php echo $this->webroot; ?>asset/masterslider/masterslider.min.js"></script> 
        <script type="text/javascript" src="<?php echo $this->webroot; ?>asset/js/master-slider-home.js"></script> 
        <!-- load cubeportfolio -->
        <script type="text/javascript" src="<?php echo $this->webroot; ?>asset/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
        <script type="text/javascript" src="<?php echo $this->webroot; ?>asset/js/portfolio-2col-custom.js"></script> 
    </body>
</html>